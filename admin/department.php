                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($department) > 0) {
                                            foreach ($department as $item) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                                                            data-bs-target="#editDepartmentModal<?= $item['id']; ?>">Edit</a>
                                                        <button type="button"
                                                ...
                                                <!-- Edit Company Modal -->
                                                <div class="modal fade" id="editDepartmentModal<?= $item['id']; ?>" tabindex="-1"
                                                                ...
                                                                <form action="code.php" method="POST">
                                                                    ...
                                                                    <div class="form-group pull-right">
                                                                        <button
                                                                            ...
                                                                            type="submit" name="edit_department">Save
                                                                            Changes</button>
                                                                    </div>
                                                                </form>
                                                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="code.php" method="POST">
                        ...
                        <div class="col-md-12 mt-3">
                            <label for=""><i class="fas fa-user"></i> Department Head</label>
                            <input type="text" name="department_head" placeholder="Enter Department Head"
                                class="form-control">
                        </div>
