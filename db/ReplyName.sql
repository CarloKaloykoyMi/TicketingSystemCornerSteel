...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2024 at 06:53 AM
...
INSERT INTO `ticket` (`ticket_id`, `user_id`, `date`, `subject`, `company`, `branch`, `department`, `requestor`, `concern`, `status`, `comment`, `date_created`) VALUES
